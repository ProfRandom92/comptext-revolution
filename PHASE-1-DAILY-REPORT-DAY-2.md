...
| Metric | Target | Actual | Status |
|--------|--------|--------|--------|
| Latency p50 | <200ms | 142ms | ✅ |
| Latency p95 | <400ms | 279ms | ✅ |
| Latency p99 | <500ms | 400ms | ✅ |
| Throughput | 1000+ ops/min | 1316 ops/min | ✅ |
...
| Metric | Target | Actual | Status |
|--------|--------|--------|--------|
| Token Savings | ≥30% | 36.8% | ✅ |
| Compression Ratio | Stable | 0.62 | ✅ |
| Memory Usage | <500MB | 211MB | ✅ |
...
**Report Generated**: 2026-04-29 10:18:55 UTC
