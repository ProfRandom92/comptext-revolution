...
interface PerformanceResult {
  ...
  memorySavings: number // percent
}

// Generate test data of varying sizes
function generateTestText(size: number, type: 'prose' | 'code' | 'mixed' = 'prose'): string {
...
function runPerformanceTest(test: PerformanceTest): PerformanceResult {
  // Generate test data
...
function printPerformanceTable(results: PerformanceResult[]) {
  console.log('\n' + '═'.repeat(130))
  console.log('PERFORMANCE BENCHMARK RESULTS')
  console.log('═'.repeat(130))

  console.log(
    '%-40s | %12s | %12s | %10s | %12s | %8s'.padEnd(130),
    'Test',
    'Input Size',
    'Output Size',
    'Time (ms)',
  ...
  for (const r of results) {
    console.log(
      '%-40s | %12s | %12s | %10.2f | %12.0f | %7.1f%'.padEnd(130),
      r.testName,
...
function printScalabilityAnalysis(results: PerformanceResult[]) {
  console.log('\n' + '═'.repeat(100))
...
function printStatistics(results: PerformanceResult[]) {
