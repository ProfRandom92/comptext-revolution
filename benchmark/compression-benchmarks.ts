...
function runBenchmark(name: string, category: string, text: string, level: 1 | 2 | 3 | 4 | 5): BenchmarkResult {
  ...
  return {
    ...
    savedTokens,
    tokenRatio,
    compressionLevel: level as 1 | 2 | 3 | 4 | 5,
    durationMs: duration
  }
}

function formatTable(results: BenchmarkResult[]) {
  console.log('\n' + '═'.repeat(140))
...
function printCategorySummary(results: BenchmarkResult[]) {
